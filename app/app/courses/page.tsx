...
export default function CoursesIndexPage() {
  ...
  return (
    <div className="space-y-6">
      <section>
        <h1 className="font-display text-4xl font-semibold tracking-tight">Course Catalog</h1>
        <p className="mt-2 text-muted">Structured quiz sets, notes, cheat sheets, and resources across your core classes.</p>
      </section>
      ...
      <Card>
        <CardBody className="grid gap-3 p-4 md:grid-cols-[1fr_auto_auto] md:items-center">
          ...
          <Button variant="ghost" onClick={() => { setSearch(""); setDifficulty("all"); }}>
            Reset filters
          </Button>
        </CardBody>
      </Card>
