...
export function FeatureStat({
  ...
  return (
    <div
      className={cn(
        "rounded-[1.15rem] border bg-surface/80 p-4 transition-all duration-200 ease-out-expo hover:border-border-accent hover:shadow-card-hover",
        toneRing[tone],
        className
      )}
    >
      ...
      <p className="mt-2 font-mono text-[1.55rem] font-bold leading-none text-text">{value}</p>
      {hint ? (
