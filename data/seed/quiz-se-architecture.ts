...
const chapter5QuestionsBase: Question[] = [
  ...
  }),
  {
    ...
    tags: ["software-engineering", "exam-2", "chapter-5", "class-diagram", "multiplicity", "guaranteed-review"],
    difficulty: "med",
...
const chapter6FundamentalsQuestionsBase: Question[] = [
  ...
  makeSingleQuestion({
    ...
    tags: ["chapter-6", "language-processing", "application-type", "guaranteed-review"],
    difficulty: "easy"
  }),
  makeSingleQuestion({
    id: "se-exam2-ch6-q9",
  ...
  questions: [
    {
      ...
      tags: [...(requireQuestionById(chapter5Questions, "se-exam2-ch5-q3").tags ?? []), "guaranteed-lecture-drill"]
    },
    {
      ...requireQuestionById(chapter5Questions, "se-exam2-ch5-q16"),
      id: "se-exam2-guaranteed-q2-mda-true-false",
      tags: [...(requireQuestionById(chapter5Questions, "se-exam2-ch5-q16").tags ?? []), "guaranteed-lecture-drill"]
    },
    {
      ...architectureQuestions[0],
    ...
    },
    {
      ...
      tags: [...(requireQuestionById(chapter6FundamentalsQuestions, "se-exam2-ch6-q11").tags ?? []), "guaranteed-lecture-drill"]
    },
    {
      ...requireQuestionById(chapter5Questions, "se-exam2-ch5-q12-short"),
      id: "se-exam2-guaranteed-q5-multiplicity-short-response",
      tags: [...(requireQuestionById(chapter5Questions, "se-exam2-ch5-q12-short").tags ?? []), "guaranteed-lecture-drill"]
    },
    {
      ...requireQuestionById(chapter6FundamentalsQuestions, "se-exam2-ch6-q8b"),
      id: "se-exam2-guaranteed-q6-language-processing-example",
      tags: [...(requireQuestionById(chapter6FundamentalsQuestions, "se-exam2-ch6-q8b").tags ?? []), "guaranteed-lecture-drill"]
    }
  ]
};
