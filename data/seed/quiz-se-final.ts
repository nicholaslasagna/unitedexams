...
const finalMockQuestions: Question[] = [
  ...
  makeSingleQuestion({
    ...
    references: ["Chapter 7 – System context", "Guaranteed final lecture image – context question"],
  ...
  makeSingleQuestion({
    ...
    references: ["Chapter 7 – Observer pattern", "Guaranteed final lecture image – observer question"],
    tags: ["chapter-7", "observer-pattern", "guaranteed-review"],
    difficulty: "med"
  }),
  makeMultiQuestion({
    ...
    references: ["Chapter 7 – Software reuse", "Guaranteed final lecture image – reuse items"],
    tags: ["chapter-7", "software-reuse", "guaranteed-review"],
    difficulty: "easy"
  }),
  makeMultiQuestion({
    ...
    references: ["Chapter 7 – Reuse costs", "Guaranteed final lecture image – reuse costs"],
    tags: ["chapter-7", "software-reuse", "costs", "guaranteed-review"],
    difficulty: "med"
  }),
  makeSingleQuestion({
  ...
  makeMultiQuestion({
    ...
    references: ["Chapter 8 – Program testing goals", "Guaranteed final lecture image – testing goals"],
    tags: ["chapter-8", "testing", "validation-testing", "defect-testing", "guaranteed-review"],
    difficulty: "easy"
  }),
  makeSingleQuestion({
  ...
  makeSingleQuestion({
    ...
    references: ["Chapter 8 – Regression testing", "Guaranteed final lecture image – regression testing"],
    tags: ["chapter-8", "regression-testing", "guaranteed-review"],
    difficulty: "easy"
  }),
  makeSingleQuestion({
  ...
  makeMultiQuestion({
    ...
    references: ["Chapter 9 – Urgent change requests", "Guaranteed final lecture image – urgent changes"],
    tags: ["chapter-9", "urgent-changes", "guaranteed-review"],
    difficulty: "easy"
  }),
  makeMultiQuestion({
    ...
    references: ["Chapter 9 – Types of maintenance", "Guaranteed final lecture image – maintenance types"],
    tags: ["chapter-9", "maintenance", "guaranteed-review"],
    difficulty: "easy"
  }),
  makeSingleQuestion({
...
const softwareEngineeringFinalFullSimulation: QuizSet = {
  ...
  description:
    "Comprehensive Software Engineering final simulation covering the Chapter 7 continuation topics, Chapter 8 testing, Chapter 9 evolution, and the guaranteed lecture-image questions you attached.",
  difficulty: "Advanced",
  estMinutes: 52,
...
const softwareEngineeringFinalGuaranteedLectureDrill: QuizSet = {
  id: "se-final-guaranteed-lecture-drill",
  courseId: "software-engineering",
  title: "Final Guaranteed Lecture Questions",
  description:
