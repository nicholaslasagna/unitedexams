...
const testReviewQuizSetReplacementsRaw: QuizSet[] = [
  ...
  },
  {
    ...
    description:
      "An 80-minute exam simulation built directly from the Spring 2025 midterm. The real test asked students to answer any five out of six prompt groups; this version includes all six so you can overprepare.",
    difficulty: "Advanced",
    estMinutes: 80,
    mode: "exam",
    isExamSimulation: true,
    questionCountTarget: 6,
    tags: ["midterm", "exam-simulation", "spring-2025", "risc-v", "pipeline"],
    ...
    questions: [
      {
        ...
        references: ["Midterm Spring 2025 - A1"],
      ...
      },
      {
        ...
        type: "free",
        prompt:
          "Spring 2025 Midterm A2. Convert the following C functions to RISC-V assembly by properly using the standard RISC-V procedure-call convention and stack. Use `a0` and `a1` to pass `a` and `b`, and use `a0` for the return value.\n\n```c\nint sumofsq (int a, int b) {\n  return square(a) + square(b);\n}\n\nint square (int a) {\n  return a * a;\n}\n```",
        explanation:
      ...
      },
      {
        ...
        type: "free",
        prompt:
          "Spring 2025 Midterm A3. Translate the assembly instruction `addi t0, zero, -101` into 32-bit RISC-V machine code in hex. Show the field mapping.",
        explanation:
      ...
      },
      {
        ...
        type: "free",
        prompt:
          "Spring 2025 Midterm A4. Translate the machine code `0x4168_0FB3` into a 32-bit RISC-V assembly instruction. Show the opcode/funct decomposition.",
        explanation:
        ...
        references: ["Midterm Spring 2025 - A4"],
      ...
      },
      {
        ...
        references: ["Midterm Spring 2025 - A5"],
      ...
      },
      {
        ...
        references: ["Midterm Spring 2025 - A6"],
