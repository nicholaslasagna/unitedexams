...
export function QuestionNavigator({
  ...
  return (
    <aside className="rounded-2xl border border-borderc bg-surface p-4">
      <p className="mb-3 text-xs font-semibold uppercase tracking-[0.14em] text-text-secondary">Navigator</p>
        ...
        {Array.from({ length: total }).map((_, idx) => {
          ...
          return (
            <button
              ...
              className={cn(
                "h-9 rounded-lg border font-mono text-xs font-semibold transition-all duration-200 ease-out-expo focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-2/70",
